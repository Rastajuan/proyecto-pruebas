...
function validacion(e) {
	...
	if (
		...
		this.querySelector("[name=repitePassword]").value
	) {
	...
	//Validacion aceptar condiciones
	if (!this.querySelector("[name=condiciones]").checked) {
		console.log("Debes aceptar las condiciones");
		msgError.innerText = "Debes aceptar las condiciones";
		e.preventDefault(); //para parar el submit
		return false; //buena practica porque devuelves true al final
	}
