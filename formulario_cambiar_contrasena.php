...
if (isset($_POST["cambiarContrasena"])) {
    ...
    if ($nueva_contrasena == $nueva_contrasena_2) {
        $usuario = ManejadorUsuario::obtenerUsuario($mail);
        if ($usuario && ManejadorUsuario::cambiarContrasena($usuario, $contrasena, $nueva_contrasena)) {
            header("location: confirmacion_cambio_contrasena.php");
        } else {
...
<body>
    <div id="formulario">
        <div class="row">
            <a href="cuenta_web_cliente.php" class="linkVolver mb-5"><i class="bi bi-arrow-left-short"></i> Volver a Mi cuenta</a>
        </div>
        <div class="row d-flex justify-content-center align-content-center">
            <form role="form" method="post" class="col-md-6" name="formulario">
                ...
                <div class="col-12 input-group mb-3">
                    ...
                    <button type="button" id="mostraOcultar3" class="input-group-text" name="mostraOcultar3" value="mostraOcultar3"><i class="bi bi-eye-fill"></i></button>
                </div>
                <div class="col-12 form-floating mb-3">
                ...
                <div class="col-12 d-flex justify-content-center">
                    <button type="submit" id="cambiarContrasena" class="btn btn-warning" name="cambiarContrasena" value="cambiar contrasena">Cambiar contraseña</button>
                </div>
    ...
    <script src="assets/js/mostrarOcultarContraCambCont.js"></script>
</body>
